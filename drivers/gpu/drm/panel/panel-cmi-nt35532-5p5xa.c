...
static int cmi_nt35532_5p5xa_on(struct cmi_nt35532_5p5xa *ctx)
{
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_PARTIAL_COLUMNS, 0xcf);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_ADDRESS_MODE, 0x01);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_3D_CONTROL, 0x01);
	dsi_dcs_write_seq(dsi, 0x3f, 0x3e);
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_VSYNC_TIMING, 0x01);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_GET_SCANLINE, 0x64);
	...
	ret = mipi_dsi_dcs_set_display_brightness(dsi, 0x0072);
	if (ret < 0) {
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_WRITE_CONTROL_DISPLAY, 0x74);
	dsi_dcs_write_seq(dsi, 0x54, 0x02);
	dsi_dcs_write_seq(dsi, MIPI_DCS_WRITE_POWER_SAVE, 0xa0);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_CABC_MIN_BRIGHTNESS, 0x34);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_GAMMA_CURVE, 0xc8);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_GAMMA_CURVE, 0x38);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_WRITE_LUT, 0x40);
	dsi_dcs_write_seq(dsi, 0x2f, 0x19);
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_PARTIAL_ROWS, 0x17);
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_PARTIAL_COLUMNS, 0x21);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_ADDRESS_MODE, 0x40);
	dsi_dcs_write_seq(dsi, 0x37, 0x26);
	dsi_dcs_write_seq(dsi, 0x38, 0x28);
	dsi_dcs_write_seq(dsi, 0x39, 0x07);

	ret = mipi_dsi_dcs_set_pixel_format(dsi, 0x38);
	if (ret < 0) {
		dev_err(dev, "Failed to set pixel format: %d\n", ret);
		return ret;
	}
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_3D_CONTROL, 0x38);
	dsi_dcs_write_seq(dsi, 0x3f, 0x0f);
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_VSYNC_TIMING, 0x40);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_GET_SCANLINE, 0x18);
	...
	ret = mipi_dsi_dcs_set_display_brightness(dsi, 0x0038);
	if (ret < 0) {
		dev_err(dev, "Failed to set display brightness: %d\n", ret);
		return ret;
	}
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_WRITE_CONTROL_DISPLAY, 0x0e);
	dsi_dcs_write_seq(dsi, 0x54, 0x07);
	dsi_dcs_write_seq(dsi, MIPI_DCS_WRITE_POWER_SAVE, 0x19);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_CABC_MIN_BRIGHTNESS, 0x22);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_READ_PPS_START, 0xb0);
...
static int cmi_nt35532_5p5xa_remove(struct mipi_dsi_device *dsi)
{
...
MODULE_AUTHOR("linux-mdss-dsi-panel-driver-generator <botbob@disroot.org>");
